...
class Edrone():
    ...
    def go_bottom(self):
        ...
        while(center_y>=cam_height/2):
            ...
            while not rospy.is_shutdown():
                ...
                e_drone.pid()
                r.sleep()
                if -0.2<e_drone.Error[1]<0.2 and -0.2<e_drone.Error[0]<0.2 :
                    e_drone.setted_y=self.drone_position[1]
                    break
                else:
                    while not rospy.is_shutdown():
    ...
    # def set_x(self):
    #     global e_drone
    #     if(center_x<=(cam_width/2)-20):
    #         print("setx left")
    #         # e_drone.setpoint= self.drone_position
    #         # print(e_drone.setpoint)
    #         # e_drone.setpoint[0]=self.drone_position[0]+1
    #         # print(e_drone.setpoint)
    #         # while (not(e_drone.drone_position[0] > e_drone.setpoint[0]+0.2 and e_drone.drone_position[0] < e_drone.setpoint[0]-0.2
    #         #    and e_drone.drone_position[1] < e_drone.setpoint[1]+0.2 and e_drone.drone_position[1] > e_drone.setpoint[1]-0.2 and
    #         #    e_drone.drone_position[2] < e_drone.setpoint[1]+0.2 and e_drone.drone_position[2] > e_drone.setpoint[1] - 0.2)):
    #         #     print("while....")
    #         #     e_drone.pid()
    #         #     time.sleep(0.05)
    #         e_drone.setpoint= self.drone_position
    ...
    #             r.sleep()
    #             if -0.2<e_drone.Error[0]<0.2 :
    #                 e_drone.setted_x=e_drone.drone_position[0]
    #                 break
    #             else:
    #                 while not rospy.is_shutdown():
    #                     e_drone.pid()
    ...
    #                 e_drone.setted_y=e_drone.drone_position[1]
    #                 break
    #             else:
    #                 while not rospy.is_shutdown():
    #                     e_drone.pid()
...
def move():
    ...
    points_array = [[0, 0, 20],[-6, 6,20], [6, 0, 20], [6, 6, 20],[-6, -6, 20], [6, -6, 20], [6, 0, 20], [0, 0, 20]]
    # i = 0
    # i = 0
    global detected
    global i
...
def go_to_goal():
    ...
    while not(center_x<(cam_width/2)-20 and center_x>(cam_width/2)+20 and center_y<(cam_height/2)-0 and center_y>(cam_height/2)+20):
       ...
       if(center_x<(cam_width/2) and center_y>(cam_height/2)):
               ...
               e_drone.go_left()
               e_drone.setpoint= [e_drone.setted_x,7,20]    
               while not rospy.is_shutdown():
                e_drone.pid()
                r.sleep()
...
if __name__ == '__main__':
    ...
    points_array = [[0, 0, 20], [6, 0, 20], [6, 6, 20], [-6, 6,20], [-6, -6, 20], [6, -6, 20], [6, 0, 20], [0, 0, 20]]
    # i = 0
